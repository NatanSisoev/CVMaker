...
#let locale-catalog-page-numbering-style = context { "Natan Sisoev - Pag. " + str(here().page()) + " de " + str(counter(page).final().first()) + "" }
#let locale-catalog-last-updated-date-style = "Last updatedd in Feb 2025"
...
#let design-section-titles-line-thickness = 0.7pt
#let design-section-titles-font-size = 1.4em
...
#let design-header-photo-width = 1.5cm
...
#let design-page-bottom-margin = 1.7cm
