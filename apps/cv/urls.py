...
urlpatterns += [
    ...
    path('settings/<uuid:settings_id>/edit/', CVSettingsUpdateView.as_view(), name='cvsettings-edit'),
    path('settings/<uuid:settings_id>/delete/', CVSettingsDeleteView.as_view(), name='cvsettings-delete'),
]