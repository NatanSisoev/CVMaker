...
class CVInfo(models.Model):
    # KEYS
    user = models.ForeignKey(settings.AUTH_USER_MODEL, null=False, blank=False, on_delete=models.CASCADE, related_name="cv_info")
...
class CVDesign(models.Model):
    ...
    # KEYS
    user = models.ForeignKey(settings.AUTH_USER_MODEL, null=False, blank=False, on_delete=models.CASCADE, related_name='cv_designs')
...
class CVLocale(models.Model):
    ...
    # KEYS
    user = models.ForeignKey(settings.AUTH_USER_MODEL, null=False, blank=False, on_delete=models.CASCADE, related_name='cv_locales')
...
class CVSettings(models.Model):
    # KEYS
    user = models.ForeignKey(settings.AUTH_USER_MODEL, null=False, blank=False, on_delete=models.CASCADE, related_name='cv_settings')
